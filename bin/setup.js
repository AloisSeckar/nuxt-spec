...
export async function specSetup(autoRun = false) {
  ...
  if (packageManager === 'pnpm') {
    try {
      if (pathExists('.npmrc')) {
        ...
        await createFileFromWebTemplate('https://raw.githubusercontent.com/AloisSeckar/nuxt-spec/refs/tags/v0.2.0-alpha.5/.npmrc',
  ...
  try {
    await createFileFromWebTemplate('https://raw.githubusercontent.com/AloisSeckar/nuxt-spec/refs/tags/v0.2.0-alpha.5/config/vitest.config.ts.template',
  ...
  if (createSampleTests) {
    try {
      await createFileFromWebTemplate('https://raw.githubusercontent.com/AloisSeckar/nuxt-spec/refs/tags/v0.2.0-alpha.5/test/browser/vitest-browser.test.ts',
        'test/browser/vitest-browser.test.ts', true)
    } catch (error) {
      console.error('Error setting up \'vitest-browser.test.ts\':\n', error.message)
    }
    try {
      await createFileFromWebTemplate('https://raw.githubusercontent.com/AloisSeckar/nuxt-spec/refs/tags/v0.2.0-alpha.5/test/e2e/nuxt-e2e.test.ts',
        'test/e2e/nuxt-e2e.test.ts', true)
    } catch (error) {
      console.error('Error setting up \'nuxt-e2e.test.ts\':\n', error.message)
    }
    try {
      await createFileFromWebTemplate('https://raw.githubusercontent.com/AloisSeckar/nuxt-spec/refs/tags/v0.2.0-alpha.5/test/e2e/nuxt-visual.test.ts',
        'test/e2e/nuxt-visual.test.ts', true)
    } catch (error) {
      console.error('Error setting up \'nuxt-visual.test.ts\':\n', error.message)
    }
    try {
      await createFileFromWebTemplate('https://raw.githubusercontent.com/AloisSeckar/nuxt-spec/refs/tags/v0.2.0-alpha.5/test/nuxt/nuxt-unit.test.ts',
        'test/nuxt/nuxt-unit.test.ts', true)
    } catch (error) {
      console.error('Error setting up \'nuxt-unit.test.ts\':\n', error.message)
    }
    try {
      await createFileFromWebTemplate('https://raw.githubusercontent.com/AloisSeckar/nuxt-spec/refs/tags/v0.2.0-alpha.5/test/unit/vitest-unit.test.ts',
