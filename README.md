...
You can use sample files from the [project repository](https://github.com/AloisSeckar/nuxt-spec/tree/v0.1.10/test).
...
See [CHANGELOG.md](https://github.com/AloisSeckar/nuxt-spec/blob/v0.1.10/CHANGELOG.md) for the latest updates and features.

## Configuration

By default, `nuxt-spec` uses Vitest configuration defined in [`/config/index.mjs`](https://github.com/AloisSeckar/nuxt-spec/blob/v0.1.10/config/index.mjs). The configuration is based on [Nuxt team recommendations](https://nuxt.com/docs/4.x/getting-started/testing) and our best judgement.
