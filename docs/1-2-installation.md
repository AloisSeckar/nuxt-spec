...
You can use sample files from the [project repository](https://github.com/AloisSeckar/nuxt-spec/tree/v0.3.2/test).
...
- run package manager's update command (e.g. `pnpm update nuxt-spec@0.3.2`) to bump `nuxt-spec` to the latest version
